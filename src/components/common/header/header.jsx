              ...
              <div className="header-element">
                <div className="horizontal-logo">
                  ...
                  >
                    ...
                    <img src={logo2} alt="logo" className="toggle-dark" />
                    <img src={logo1} alt="logo" className="desktop-white" />
                    <img src={logo2} alt="logo" className="toggle-white" />
                  </a>
                </div>
              </div>
              <div
             ...
             rounded-full font-medium text-defaulttextcolor  transition-all text-xs dark:bg-bodybg dark:bg-bgdark dark:hover:bg-black/20 dark:text-[#8c9097] dark:text-white/50 dark:hover:text-white dark:focus:ring-white/10 dark:focus:ring-offset-white/10"
              ...
              <div className="header-element md:!px-[0.65rem] px-2 hs-dropdown !items-center ti-dropdown [--placement:bottom-left]">
                <button
                  id="dropdown-profile"
                  type="button"
                  className="w-8 h-8  hs-dropdown-toggle ti-dropdown-toggle !gap-2 !p-0 flex-shrink-0 sm:me-2 me-0 !rounded-full !shadow-none text-xs align-middle !border-0 !shadow-transparent "
                >
                  {renderImage(
                    user?.user_data?.user_profile.profile_picture,
                    8,
                    8
                  )}
                </button>
                <div className="md:block hidden dropdown-profile cursor-pointer">
                  <p className="font-semibold mb-0 leading-none text-[#536485] text-[0.813rem] capitalize">
                    {user?.user_data?.username}
                  </p>
                  <span className="opacity-[0.7] font-normal text-[#536485] block text-[0.6875rem] capitalize">
