...
import logo1 from "../../../assets/images/brand-logos/ims_logo.png";
import logo2 from "../../../assets/images/brand-logos/toggle.png";
...
const Sidebar = ({ local_varaiable, ThemeChanger }) => {
  ...
  return (
    <Fragment>
      ...
      >
        <div className="main-sidebar-header !h-24 !pb-10">
          <a href={`/`} className="header-logo mt-10 transform scale-150">
            <img src={logo1} alt="logo" className="desktop-dark" />
            <img src={logo2} alt="logo" className="toggle-logo" />
          </a>
        </div>
        <SimpleBar className="main-sidebar !mt-24 !-pb-80" id="sidebar-scroll">
              ...
              {MENUITEMS.map((levelone) => (
                <Fragment key={Math.random()}>
                  ...
                  >
                    ...
                    {levelone.type === "link" &&
                    levelone.role.includes(
                      user?.user_data?.user_profile?.role?.name
                    ) ? (
                      <Link
                        to={levelone.path + "/"}
